...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Visualize AUPRC for All KMER DNABERT Models"
    )
    parser.add_argument(
        "-i",
        "--input_dir",
...
for k in [3,4,5,6]:
    ...
    module = "scripts.analysis.visualize.training.per_eval_step"
    metric_key = "eval_auprc_macro"
    
    key_label = "AUPRC (Macro)"
    graph_title = f"AUPRC (Macro) During Training (DNABERT K={k})"
